...
public abstract class Command extends BukkitCommand implements CommandExecutor {
    ...
    public void sendUsage(CommandSender sender){
        sender.sendMessage(Instances.stringsInstance.format("Usage", "%USAGE%", getUsage(), (Player) sender));
    }

    public void sendMessage(CommandSender sender, String text){
        sender.sendMessage(Instances.stringsInstance.format(text));
    }

    public void sendMessage(CommandSender sender, String text, String placeholders, String replaces){
        sender.sendMessage(Instances.stringsInstance.format(text, placeholders, replaces, (Player) sender));
    }
